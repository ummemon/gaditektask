...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form  action="{{url('stripe')}}"  data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" name="frmStripe" id="frmstripe" method="post">
                {{ csrf_field() }}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-control total btn btn-primary">
                            Total: <span class="amount">${{ $totalamount }}</span>
                        </div>
                    </div>
                </div>
                <div class="row">
